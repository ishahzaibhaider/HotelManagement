								...
								<div class="col-xs-8">
									...
									{if ($hotel['latitude'] != 0 || $hotel['longitude'] != 0) && $viewOnMap}
										<p class="hotel-branch-info-value">
											<a class="btn htl-map-direction-btn" href="https://www.openstreetmap.org/directions?engine=fossgis_osrm_car&route=;{$hotel['latitude']},{$hotel['longitude']}" target="_blank">
